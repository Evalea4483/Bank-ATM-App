...
public class ATM {
    public static void main(String[] args)  {
        ...
        // init Bank
        Bank theBank = new Bank("Bank of Lakeside");

        // add a user, which also creates a savings account
        User aUser = theBank.addUser("Gwendolyn", "Stephenson","7427");
    ...
    public static User mainMenuPrompt(Bank theBank, Scanner sc) {
        ...
        do {
            ...
            if (authUser == null) {
                System.out.println("Inccorrect user ID/pin combination. " +
                "Please try again.");
            }
    ...
    public static void withdrawFunds(User theUser, Scanner sc) {
        ...
        // get the account to transfer from
        do {
            System.out.printf("Enterthe number (1-%d) of the account\n" +
        ...
        // gobble uo rest of previous input line
        sc.nextLine();
